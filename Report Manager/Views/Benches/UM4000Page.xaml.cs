...
public sealed partial class UM4000Page : Page
{
    ObservableCollection<object> collection = new ObservableCollection<object>();
    public DataTable data = new DataTable();
    public DataTable FilterData = new DataTable();
    public static UM4000Page? UMCurrent;
    public UM4000ViewModel ViewModel
    {
        get;
    }
    ...
    public UM4000Page()
    {
        ViewModel = App.GetService<UM4000ViewModel>();
        InitializeComponent();
        UMCurrent = this;
        FilterData = data;
        ...
        TemplateSelector.Selector("TemplateFolder2", CbxTemplates);
    }
    private async void Page_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        DataRetriever.UM4000(dataGrid, collection, data);
    ...
    {
        FilterByDate.FilterUM(data, SnFilter, dataGrid, Date1, Date2, TbxInit, TbxFinal);
    }
    ...
    private void DataFilter_Unchecked(object sender, RoutedEventArgs e)
    {
        ...
        {
            FilterBySN.FilterUM(data, SnFilter, dataGrid, Date1, Date2, TbxInit, TbxFinal);
        }
        else
        {
    ...
    {
        FilterBySN.FilterUM(data, DateFilter, dataGrid, Date1, Date2, TbxInit, TbxFinal);
    ...
    private void dataGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        DataGridResultsPreview.ShowPreviewUM(dataGrid, SeeMoreInfo, ResultsPreview, ResultsGrid);
    ...
    private async void btnRefresh_Click(object sender, RoutedEventArgs e)
    {
        ...
        btnRefresh.Content = "RefreshButton".GetLocalized();
